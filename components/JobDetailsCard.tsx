    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <EditableField
            field="adjusterName"
            value={jobData.adjusterName || jobData.claimRep || jobData.adjusterId || 'Not provided'}
            label="Adjuster Name"
          />
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-1">
                ...
                <span>{(roofMeasurements.totalRoofArea || roofMeasurements.roofArea || roofMeasurements.totalArea || 0).toLocaleString()} SF</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Squares</Label>
                <span>{roofMeasurements.numberOfSquares || roofMeasurements.totalSquares || 'N/A'}</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Pitch</Label>
                <span>{roofMeasurements.predominantPitch || roofMeasurements.pitch || 'N/A'}</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Stories</Label>
                <span>{roofMeasurements.numberOfStories || roofMeasurements.stories || 'N/A'}</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-1">
                ...
                <span>{roofMeasurements.totalEaves || roofMeasurements.eavesLength || 'N/A'} LF</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Rakes</Label>
                <span>{roofMeasurements.totalRakes || roofMeasurements.rakesLength || 'N/A'} LF</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Ridges</Label>
                <span>{roofMeasurements.totalRidges || roofMeasurements.ridgeLength || 'N/A'} LF</span>
              </div>
              <div className="space-y-1">
                <Label className="text-muted-foreground">Valleys</Label>
                <span>{roofMeasurements.totalValleys || roofMeasurements.valleysLength || 'N/A'} LF</span>
              </div>
            </div>
          </div>
        )}
