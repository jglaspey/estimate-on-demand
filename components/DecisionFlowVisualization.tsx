...
export function DecisionFlowVisualization({ ruleName, onStepClick, onEvidenceClick }: DecisionFlowProps) {
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {step.evidence && (
                <button
                  onClick={() => step.evidence && onEvidenceClick?.(step.evidence.location, step.evidence.docType)}
